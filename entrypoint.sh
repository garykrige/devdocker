...
git clone https://${GITHUB_USER}:${GITHUB_TOKEN}@github.com/superbalist/cms.superbalist.com.git
git clone https://${GITHUB_USER}:${GITHUB_TOKEN}@github.com/superbalist/superbalist-kubernetes.git
